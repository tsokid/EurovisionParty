...
export const copy: Record<Locale, FaqCopy> = {
  ...
  el: {
    ...
    more: [
      ...
      { q: 'Πώς διαχειρίζεστε τα αποτελέσματα της Eurovision;', a: 'Είτε ο οικοδεσπότης καταχωρεί ζωντανά τα αποτελέσματα κριτικής επιτροπής και televote, είτε ο auto-parser τα τραβάει από την επίσημη πηγή τη βραδιά του τελικού.' },
