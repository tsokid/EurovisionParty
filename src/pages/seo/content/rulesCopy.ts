  ...
  en: {
    ...
    duels: {
      ...
      items: [
        ...
        { strong: 'Per-pair cap.', rest: 'Default 3, max 10 across the night, counts rematches \u2014 you cannot grind one opponent.' },
    ...
    cta: {
      ...
      body: 'Default rules work for most groups. Open the host panel to toggle sudden death and adjust quiz rounds.',
      primary: 'Create room',
      secondary: 'Scoring',
    },
    related: {
  ...
  el: {
    ...
    duels: {
      ...
      items: [
        ...
        { strong: 'Όριο ανά ζευγάρι.', rest: 'Προεπιλογή 3, μέγιστο 10 σε όλη τη βραδιά, μετράει τις ρεβάνς \u2014 δεν μπορείς να εκμεταλλεύεσαι έναν αντίπαλο.' },
    ...
    cta: {
      ...
      body: 'Οι προεπιλογές δουλεύουν για τις περισσότερες παρέες. Άνοιξε το host panel για να ενεργοποιήσεις sudden death και να ρυθμίσεις τους γύρους quiz.',
